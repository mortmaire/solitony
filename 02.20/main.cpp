...
),(int)p.T,(int)p.L/100*100,gpid,ffrk);
...
if(p0.T==1)p0.T=3;
else if(p0.T==3)p0.T=30;
else if(p0.T==30)p0.T=100;
else if(p0.T==100)p0.T=300;
else if(p0.T==300)break;
}
cout<<"End of line: "<<ffrk<<endl;
