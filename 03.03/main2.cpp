...
if(ffrk-'a'>10)return 0;

for(int i=0;i<8192;i++){
if(i%11!=ffrk-'a')continue;
int n=choice(i);
p0.T=n;
ffal psi;
psi.evolve();
stringstream name;
name<<"./data/T"<<setw(4)<<setfill('0')<<n;
psi.save(name.str().c_str());
psi.statystyka((name.str()+".a").c_str());
psi.antisym((name.str()+".b").c_str());
}
