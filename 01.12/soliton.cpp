...
parameters(double dx=0.1,double L=200,double gamma=0.01,double T=4000,double mu=1,double g=0.01,double dt=0.01,double time=1000,double max=20,double nn=1000):dx(dx),L(L),gamma(gamma),T(T),mu(mu),g(g),dt(dt),time(time),max(max),nn(nn){}
} p0;
